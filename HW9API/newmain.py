...
def create_item(item: InventoryItem, serial_num: str) -> None:  #This is for the output, so that it will say None instaed of just "string"
...
def get_items() -> List[InventoryItem]:
    return my_inventory_item_dict.values()  #We are only wanting a list of the values, not the whole dictionary.
